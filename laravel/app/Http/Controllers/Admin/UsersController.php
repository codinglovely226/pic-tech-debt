...
class UsersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        //Site Admin role = 3
        $role= $roles['0']->id; //there really has to be a better way than this..
        $teams= $user->team()->get();
        $team = $teams['0']->id;
        ...
        if ($request->ajax()) {
            ...
            $table->editColumn('user_job', function ($row) {
                return $row->user_job ? User::USER_JOB_SELECT[$row->user_job] : '';
            });
