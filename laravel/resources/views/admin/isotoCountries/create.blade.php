...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.isotoCountry.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.isoto-countries.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="country_name">{{ trans('cruds.isotoCountry.fields.country_name') }}</label>
                <input class="form-control {{ $errors->has('country_name') ? 'is-invalid' : '' }}" type="text" name="country_name" id="country_name" value="{{ old('country_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('iso_alpha_2') ? 'is-invalid' : '' }}" type="text" name="iso_alpha_2" id="iso_alpha_2" value="{{ old('iso_alpha_2', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('iso_alpha_3') ? 'is-invalid' : '' }}" type="text" name="iso_alpha_3" id="iso_alpha_3" value="{{ old('iso_alpha_3', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('iso_un_m_49') ? 'is-invalid' : '' }}" type="number" name="iso_un_m_49" id="iso_un_m_49" value="{{ old('iso_un_m_49', '0') }}" step="1">
