...
@can('site_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @include('csvImport.modal', ['model' => 'Site', 'route' => 'admin.sites.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
                ...
                <tr>
                    ...
                    <td>
                        <select class="search">
                            ...
                            @foreach($isoto_countries as $key => $item)
...
{ data: 'site_default_time_zone', name: 'site_default_time_zone' },
{ data: 'country_country_name', name: 'country.country_name' },
