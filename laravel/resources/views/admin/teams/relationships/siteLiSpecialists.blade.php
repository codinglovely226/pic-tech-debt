...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-siteLiSpecialists">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.specialist.fields.site_li') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($specialists as $key => $specialist)
                        <tr data-entry-id="{{ $specialist->id }}">
                            ...
                            <td>
                                @foreach($specialist->site_lis as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-siteLiSpecialists:not(.ajaxTable)').DataTable({ buttons: dtButtons })
