    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('user_phone') ? 'is-invalid' : '' }}" type="text" name="user_phone" id="user_phone" value="{{ old('user_phone', $user->user_phone) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('user_job') ? 'is-invalid' : '' }}" name="user_job" id="user_job" required>
                    ...
                    @foreach(App\User::USER_JOB_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('user_job', $user->user_job) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
